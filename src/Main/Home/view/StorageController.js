    ...
    return <View style={[CommonStyles.container, {marginTop: INSETS.top}]}>
        ...
        <XView>
            <XView style={{flexDirection: 'row'}}>
                ...
                <RNItem text='获取字符串' style={{flex: 1}} onPress={() => setText(RNStorage.str + dateFormat(new Date(), 'yyyy-MM-dd hh:mm'))}/>
            </XView>
            <XView style={{flexDirection: 'row'}}>
        ...
        <ScrollView>{
            Object.keys(RNStorage).map((key) => <XView key={key} style={{backgroundColor: Colors.split_line, marginBottom: 1, padding: 10}}>
